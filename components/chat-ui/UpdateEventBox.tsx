...
// ============================================================================
// Update Event Box Component - Confirms event update with preview
// ============================================================================

export interface UpdateEventBoxProps {
    messageId: string;
    event: CalendarEvent;
    calendars?: CalendarCategory[];
    onAnswer: (answer: 'update' | 'cancel') => void;
    disabled?: boolean;
}

export function UpdateEventBox({
    messageId,
    event,
    calendars = [],
    onAnswer,
    ...
    return (
        ...
        >
            ...
            <div className="flex items-start gap-2 mb-4">
                <span className="material-symbols-outlined text-blue-500 text-xl mt-0.5">edit</span>
                <p className="text-foreground font-medium">Do you want to update this event?</p>
            </div>
            ...
            <div className="flex gap-2">
                <motion.button
                    ...
                    onClick={() => !disabled && onAnswer('update')}
                    disabled={disabled}
                    className={clsx(
