  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed right-6 top-20 bottom-6 w-[420px] bg-[#202124]/85 backdrop-blur-xl rounded-2xl shadow-[0_24px_48px_rgba(0,0,0,0.75)] border border-white/10 font-sans text-[#e8eaed] z-50 overflow-hidden flex flex-col transition-all duration-200 ease-out ${!isOpen ? 'translate-x-[480px] opacity-0' : 'translate-x-0 opacity-100'}`}
      >
        {/* Header */}
        <div className="flex-none flex items-center justify-between px-4 py-3 bg-transparent border-b border-white/10">
          <div className="flex items-center gap-1 text-sm text-[#9aa0a6] hover:bg-white/5 px-2 py-1 rounded cursor-pointer transition-colors">
          ...
          <div className="flex items-center gap-1">
            ...
            <button onClick={handleClose} className="w-8 h-8 flex items-center justify-center text-[#9aa0a6] hover:text-[#e8eaed] hover:bg-white/10 rounded-full transition-colors">
